...
export class Gration081716719190442 implements MigrationInterface {
    name = 'Gration081716719190442'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`movie\` CHANGE \`active\` \`active\` tinyint NOT NULL DEFAULT 1`);
        ...
        await queryRunner.query(`ALTER TABLE \`schedule\` CHANGE \`active\` \`active\` tinyint NOT NULL`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`schedule\` CHANGE \`active\` \`active\` tinyint(1) NULL`);
        ...
        await queryRunner.query(`ALTER TABLE \`movie\` CHANGE \`active\` \`active\` tinyint(1) NOT NULL DEFAULT '1'`);
