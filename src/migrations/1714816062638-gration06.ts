...
export class Gration061714816062638 implements MigrationInterface {
    name = 'Gration061714816062638'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`bill\` ADD UNIQUE INDEX \`IDX_1754cb88f6459217703498f510\` (\`payment_online_code\`)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE \`bill\` DROP INDEX \`IDX_1754cb88f6459217703498f510\``);
